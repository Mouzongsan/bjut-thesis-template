...
% =============================================================
\bjutset{
  clc            = {O413},                   % 中图分类号（在国家图书馆官网查询，例如 O413 = 量子力学）
  udc            = {530.145},                % UDC 分类号（与中图分类号对应，可留空 {}）
  schoolcode     = {10005},                  % 学校代码（北工大固定为 10005，勿改）
  secretlevel    = {公开},                    % 密级：公开 / 限制 / 秘密 / 机密
  ctitle         = {论文中文题目},            % 中文题目
  cauthor        = {作者姓名},                % 作者姓名（中文）
  cdiscipline    = {学科名称},                % 一级学科名称，如：物理学 / 机械工程
  csupervisor    = {导师姓名},                % 导师姓名
  csupervstitle  = {教授},                   % 导师职称，如：教授 / 副教授（可留空 {}）
  cdate          = {2025年6月},              % 答辩 / 提交年月
  studentid      = {S202200001},             % 学号（研究生学号格式，按实际填写）
  etitle         = {English Title of the Thesis},  % 论文英文题目
